...
# Uso: levanta la base, corre este nodo, y con rqt_reconfigure pon start_test=true.
# Ajusta odom_angular_scale_correction hasta que el giro real iguale test_angle.
import time
import rclpy
import signal
import threading
