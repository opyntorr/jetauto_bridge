#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Portado del paquete oficial Hiwonder 'calibration'. ÚNICO cambio: publica en
# /cmd_vel (lo que escucha nuestro chassis_node I2C) en vez de /controller/cmd_vel.
# Uso: levanta la base (ros2 launch jetauto_bringup robot.launch.py), luego este nodo,
# y con rqt_reconfigure pon start_test=true. Ajusta odom_linear_scale_correction hasta
# que el carrito recorra test_distance real; ese factor afina la odometría.
import time
import rclpy
import signal
import threading
