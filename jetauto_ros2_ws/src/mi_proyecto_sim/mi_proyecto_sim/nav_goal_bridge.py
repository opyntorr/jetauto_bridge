...
class NavGoalBridge(Node):
    ...
    def initialpose_cb(self, msg):
        # En modo AMCL, AMCL maneja la localizacion directamente via /initialpose.
        # map->map_dron_origin permanece identidad (mismo mapa pre-construido en ambos frames).
        self.get_logger().info('2D Pose Estimate recibido (AMCL lo procesa; alineacion = identidad).')
